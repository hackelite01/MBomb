...
def do_zip_update():
    success = False
    if DEBUG_MODE:
        zip_url = "https://github.com/hackelite01/MBomb/archive/dev.zip"
        dir_name = "MBomb-dev"
    else:
        zip_url = "https://github.com/hackelite01/MBomb/archive/master.zip"
...
def notifyen():
    try:
        if DEBUG_MODE:
            url = "https://github.com/hackelite01/MBomb/raw/dev/.notify"
        else:
            url = "https://github.com/hackelite01/MBomb/raw/master/.notify"
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("MBomb was created by HackElite")
...
__CONTRIBUTORS__ = ['HackElite', 'Mayank']
